...
news:
  ...
  - title: Hospital needs volunteers to cuddle babies
    ...
    source: CNN
    description: Doctors know the healing power of touch, especially for pre-term
      babies or those born with addiction or other health issues.
  ...
  - title: Cases of lung disease possibly linked to vaping continue to rise. This
      teen was given a 'second chance'
    ...
    source: CNN
    description: US health officials announced Friday that as of August 27, there
      are at least 215 possible cases in 25 states of severe lung disease that could
      be caused by vaping.
  msnbc:
  - *2
  ...
  - title: Visiting with the Tallest Disney Fan I Know
    ...
    source: ABC News
    description: While naming anyone the world’s “biggest” Disney fan would ignite
      the kind of debate we prefer to avoid around the Disney Files newsroom, I’m
      pretty comfortable saying that twin brothers and NBA stars Brook and Robin Lopez
  ...
  - title: 11 Texas judges broke law with blanket denial of free bail
    ...
    description: Texas' judicial ethics commission has publicly admonished 11 current
      and former state judges for indiscriminately denying free bail to thousands
      of poor people charged with crimes
