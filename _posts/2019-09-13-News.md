...
news:
  ...
  - title: 'Markets Right Now: Stocks mixed as banks rise but tech falls'
    ...
    image: 
    source: ABC News
    description: Stocks are having a mixed performance early on Wall Street Friday
      as gains in banks and energy companies are offset somewhat by a drop in technology
      stocks.
  ...
  - title: Civil War cannonball found in Kansas City area tree
    ...
    description: Get breaking national and world news, broadcast video coverage, and
      exclusive interviews. Find the top news online at ABC news.
  cnbc:
  - title: "'Stop the WeWork deal' — Cramer says the embattled IPO could wreck the
      stock market rally"
